...
latex_documents = [
  ('index', 'handler.tex', u'DataHandler Documentation',
   u'Todd Young', 'manual'),
]
...
man_pages = [
    ('index', 'handler', u'DataHandler Documentation',
     [u'Todd Young'], 1)
]
...
texinfo_documents = [
  ('index', 'handler', u'DataHandler Documentation',
   u'Todd Young', 'handler', 'One line description of project.',
   'Miscellaneous'),
]
